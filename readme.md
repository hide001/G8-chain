...
**Note regarding use of GPUs -** GPUs are primarily used in POW consensus chains. Being a DPos G8-chain chain has not only more TPS and fast block production but also doesn't need a GPU altogether for its purpose.



## How to become a validator
To back the G8-chain blockchain you can become a validator. Full flow to become a validator, you must:
...
To install the G8-chain validator node in ubuntu linux
```bash
  sudo -i
